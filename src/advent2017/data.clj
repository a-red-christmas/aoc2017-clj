...
(def data1 "")

(def data2 "4347  3350  196 162 233 4932  4419  3485  4509  4287  4433  4033  207 3682  2193  4223
...
(def data4 "vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
...
(def data8 "koq inc 675 if xrh >= -6
  it inc -402 if s < -1
  g inc 283 if oj != -3
  it inc 355 if y <= 5
  do dec 553 if g != 288
